# Generated by Django 4.0.3 on 2022-03-25 03:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('wfrp', '0002_alter_campaign_options_alter_journalentry_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_level', models.CharField(max_length=32)),
                ('career_path', models.CharField(max_length=32)),
                ...
                ('mother', models.CharField(max_length=32)),
                ('father', models.CharField(max_length=32)),
                ('siblings', models.CharField(max_length=32)),
                ('couple', models.CharField(max_length=32)),
                ('birthplace', models.CharField(max_length=32)),
                ('background_story', models.TextField()),
                ('personal_relations', models.TextField()),
                ...
                ('short_term_ambitions', models.TextField()),
                ('long_term_ambitions', models.TextField()),
